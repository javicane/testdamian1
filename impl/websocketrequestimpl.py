...
class WebsocketRequestImpl(object):
    ...
    def subscribe_user_data_event(self, listenKey, callback, error_handler=None):
        print("in impl.websocketrequestimpl.WebsocketRequestimpl.subscribe_user_data_event BEGIN")
        check_should_not_none(listenKey, "listenKey")
        check_should_not_none(callback, "callback")
        #print("in impl.websocketrequestimpl.WebsocketRequestimpl.subscribe_user_data_event callback is: " + str(callback))
        #print("in impl.websocketrequestimpl.WebsocketRequestimpl.subscribe_user_data_event callback is type: " + str(type(callback)))
        ...
        def json_parse(json_wrapper):
            print("in impl.websocketrequestimpl.WebsocketRequestimpl.subscribe_user_data_event.json_parse BEGIN")
            #print("in impl.websocketrequestimpl.WebsocketRequestimpl.subscribe_user_data_event.json_parse event type: ", json_wrapper.get_string("e"))
            #print("in impl.websocketrequestimpl.WebsocketRequestimpl.subscribe_user_data_event.json_parse json_wrapper: " + str(json_wrapper))
            ...
            #print("in impl.websocketrequestimpl.WebsocketRequestimpl.subscribe_user_data_event.json_parse result: " + str(result))
            #print("in impl.websocketrequestimpl.WebsocketRequestimpl.subscribe_user_data_event.json_parse END")
            return result
        ...
        #print("in impl.websocketrequestimpl.WebsocketRequestimpl.subscribe_user_data_event END")
        return request
