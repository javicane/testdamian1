...
class JsonWrapper:
    ...
    def __init__(self, json_object):
        #print("in impl.utils.jsonwrapper.JsonWrapper.__init__ recibe un json al que se le puede scannear con los atributos de esta clase BEGIN")
        self.json_object = json_object
        #print("in impl.utils.jsonwrapper.JsonWrapper.__init__ END")
