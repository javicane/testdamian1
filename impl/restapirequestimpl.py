...
class RestApiRequestImpl(object):
    ...
    def __init__(self, api_key, secret_key, server_url="https://dapi.binance.com"):
        ...
        #print("in impl.restapirequestimpl.RestApiRequestImpl __init__")
    ...
    def __create_request_by_get_with_apikey(self, url, builder):
        print("in impl.restapirequestimpl.__create_request_by_get_with_apikey BEGIN")
        request = RestApiRequest()
        request.method = "GET"
        request.host = self.__server_url
        request.header.update({'Content-Type': 'application/json'})
        ...
        request.url = url + "?" + builder.build_url()
         # For develop
        #print(".... in impl.restapirequestimpl.__create_request_by_get_with_apikey request: " + str(request))
        #print(".... .... in impl.restapirequestimpl.__create_request_by_get_with_apikey call PrintMix.print_data(request) BEGIN")
        #PrintMix.print_data(request)
        #print(".... .... in impl.restapirequestimpl.__create_request_by_get_with_apikey call PrintMix.print_data(request) END")
        #print("in impl.restapirequestimpl.__create_request_by_get_with_apikey return request END")
        return request

    def __create_request_by_post_with_signature(self, url, builder):
        #pdb.set_trace()
        print(".... .... in impl.restapirequestimpl.RestApiRequestimpl.__create_request_by_post_with_signature BEGIN")
        request = RestApiRequest()
        request.method = "POST"
        request.host = self.__server_url
        builder.put_url("recvWindow", 60000)
        builder.put_url("timestamp", str(get_current_timestamp() - 1000))
        #print(".... .... .... in impl.restapirequestimpl.RestApiRequestimpl.__create_request_by_post_with_signature call create_signature BEGIN")
        create_signature(self.__secret_key, builder)
        #print(".... .... .... in impl.restapirequestimpl.RestApiRequestimpl.__create_request_by_post_with_signature call create_signature END")
        request.header.update({'Content-Type': 'application/json'})
        request.header.update({"X-MBX-APIKEY": self.__api_key})
        request.post_body = builder.post_map
        request.url = url + "?" + builder.build_url()
        # For develop
        #print(".... .... .... in impl.restapirequestimpl.__create_request_by_post_with_signature request: " + str(request))
        #print(".... .... .... in impl.restapirequestimpl.__create_request_by_post_with_signature PrintMix.print_data(request) BEGIN")
        #PrintMix.print_data(request)
        #print(".... .... .... in impl.restapirequestimpl.__create_request_by_post_with_signature PrintMix.print_data(request) END")
        #print(".... .... in impl.restapirequestimpl.RestApiRequestimpl.__create_request_by_post_with_signature return request END")
        return request
    ...
    def __create_request_by_delete_with_signature(self, url, builder):
        ...
        request.url = url + "?" + builder.build_url()
        # For develop
        #print("====== Request ====== in impl.restapirequestimpl.__create_request_by_delete_with_signature BEGIN")
        #print("======= request: " + str(request))
        #print("======= ==== PrintMix.print_data(request) BEGIN")
        #PrintMix.print_data(request)
        #print("======= ====  PrintMix.print_data(request) END")
        #print("====== Request ====== in impl.restapirequestimpl.__create_request_by_delete_with_signature END")
        return request
    ...
    def __create_request_by_get_with_signature(self, url, builder):
        ...
        request.url = url + "?" + builder.build_url()
        # For develop
        #print("====== Request ====== in impl.restapirequestimpl.__create_request_by_get_with_signature BEGIN")
        #print("======= request: " + str(request))
        #print("======= ==== PrintMix.print_data(request) BEGIN")
        #PrintMix.print_data(request)
        #print("======= ====  PrintMix.print_data(request) END")
        #print("====== Request ====== in impl.restapirequestimpl.__create_request_by_get_with_signature END")
        return request
    ...
    def __create_request_by_put_with_signature(self, url, builder):
        ...
        request.method = "PUT"
        request.host = self.__server_url
        builder.put_url("recvWindow", 120000)
        #builder.put_url("recvWindow", 60000)
        builder.put_url("timestamp", str(get_current_timestamp() - 1000))
        create_signature(self.__secret_key, builder)
        request.header.update({'Content-Type': 'application/json'})
        ...
        request.url = url + "?" + builder.build_url()
        # For develop
        print("====== Request ====== in impl.restapirequestimpl.__create_request_by_put_with_signature BEGIN")
        print("======= request: " + str(request))
        print("======= request: should be keep_user_data_stream")
        #print("======= ==== PrintMix.print_data(request) BEGIN")
        #PrintMix.print_data(request)
        #print("======= ====  PrintMix.print_data(request) END")
        print("====== Request ====== in impl.restapirequestimpl.__create_request_by_put_with_signature END")
        return request
    ...
    def put_order(self, side, symbol, quantity, price, origClientOrderId):
        print("in impl.restapirequestimpl.RestApiRequestimpl.put_order BEGIN")
        check_should_not_none(symbol, "symbol")
        builder = UrlParamsBuilder()
        ...
        #print('in impl.restapirequestimpl.RestApiRequestimpl.put_order call self.__create_request_by_put_with_signature("/dapi/v1/order", builder)')
        ...
        request.json_parser = parse
        #print("in impl.restapirequestimpl.RestApiRequestimpl.put_order END")
        return request
    ...
    def post_order(self, symbol, side, ordertype, 
        ...
        print("in impl.restapirequestimpl.RestApiRequestimpl.post_order BEGIN")
        check_should_not_none(symbol, "symbol")
        ...
        print('in impl.restapirequestimpl.RestApiRequestimpl.post_order call self.__create_request_by_post_with_signature("/dapi/v1/order", builder)')
        ...
        request.json_parser = parse
        #print("in impl.restapirequestimpl.RestApiRequestimpl.post_order END")
        return request
    ...
    def start_user_data_stream(self):
        print("in impl.restapirequestimpl.RestApiRquestImpl.start_user_data_stream BEGIN")
        builder = UrlParamsBuilder()

        request = self.__create_request_by_post_with_signature("/dapi/v1/listenKey", builder)

        def parse(json_wrapper):
            print("in impl.restapirequestimpl.RestApiRquestImpl.start_user_data_stream.parse BEGIN")
            result = json_wrapper.get_string("listenKey")
            #print("in impl.restapirequestimpl.RestApiRquestImpl.start_user_data_stream.parse result: " + str(result))
            #print("in impl.restapirequestimpl.RestApiRquestImpl.start_user_data_stream.parse result type is: " + str(type(result)))
            #print("in impl.restapirequestimpl.RestApiRquestImpl.start_user_data_stream.parse return END")
            return result

        request.json_parser = parse
        #print(".... in impl.restapirequestimpl.RestApiRquestImpl.start_user_data_stream after call request.json_parser=parse")
        #print(".... in impl.restapirequestimpl.RestApiRquestImpl.start_user_data_stream request:" + str(request))
        #print(".... in impl.restapirequestimpl.RestApiRquestImpl.start_user_data_stream request type is: " + str(type(request)))
        #print("in impl.restapirequestimpl.RestApiRquestImpl.start_user_data_stream return request END")
        return request
