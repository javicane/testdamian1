class OrderUpdate:
    def __init__(self):
        #print("in model.orderupdate.OrderUPdate.__init__ declara variables BEGIN")
        self.eventType = ""
        self.eventTime = 0
        ...
        #print("in model.orderupdate.OrderUPdate.__init__ declara variables END")


    @staticmethod
    def json_parse(json_data):
        #print("in model.orderupdate.OrderUpdate.json_parse BEGIN")
        #print("in model.orderupdate.OrderUpdate.json_parse parameter json_data:" + str(json_data))
        result = OrderUpdate()
        ...
        #print("in model.orderupdate.OrderUpdate.json_parse  result: " + str(result))
        # damian
        result.realizedprofit = data_group.get_float("rp")
        #print("in model.orderupdate.OrderUpdate.json_parse END")
