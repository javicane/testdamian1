...
#input("#### #### in example_d.user.subscribeuserdata.py call sub_client.subscribe_user_data_event(listen_key, callback, error), pec")
sub_client.subscribe_user_data_event(listen_key, callback, error)
sub_client.subscribe_mark_price_event("adausd_perp", callback, error)
print("marca final")
#### in example_d.user.subscribeuserdata.py call sub_client = SubscriptionClient(api_key=g_api_key, secret_key=g_secret_key, pec
#    f = self._pool.submit(run_job, job, job._jobstore_alias, run_times, self._logger.name)
#  File "C:\Program Files\Python310\lib\concurrent\futures\thread.py", line 167, in submit
#    raise RuntimeError('cannot schedule new futures after shutdown')
# fixed in apscheduler 3.9.1 
...
#https://github.com/agronholm/apscheduler/commit/425849341fb68aafdcb4ef75b7d2710e18f21722
