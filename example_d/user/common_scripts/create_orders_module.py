...
def silent_limit_no_oco_sell_long(p_price, p_size, p_clientorderid):
    '''
    ...
    '''
    print("in create_orders_module.silent_limit_no_oco_sell_long arg p_clientorderid: " + str(p_clientorderid))
    ...
    result = request_client.post_order(symbol=p_symbol_name, side=p_side, ordertype=p_order_type, price=p_price, quantity=p_quantity, timeInForce=p_timeinforce, positionSide=p_positionside, newClientOrderId=p_clientorderid)
    #print("result raw: " + str(result))
    #print("###")
    #PrintBasic.print_obj(result)
    return result

def silent_limit_no_oco_buy_long(p_price, p_size, p_clientorderid):
    '''
    ...
    print("in create_orders_module.silent_limit_no_oco_buy_long arg p_clientorderid: " + str(p_clientorderid))
    p_symbol_name = "ADAUSD_PERP"
